...
def main():
    ...
    if len(genes1) <= 3:
        ...
        if total_size < 14:
            ...
            # Explicitly stop if total_size >= 14
            print("No file written because total_size >= 14")
            return
